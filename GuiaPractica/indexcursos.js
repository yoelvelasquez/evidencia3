...
const cursosRouter = require("../routes/cursos"); // Cambiado de usuarioAdministradorRouter a cursosRouter
...
const adapter = new FileSync("crs.json");
const db = low(adapter);

// Inicializamos la BD
db.defaults({ cursos: [] }).write(); // Cambiado de usuarioadministrador a cursos
